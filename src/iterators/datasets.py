...
CAM_NAMES = [
    'cam1', 'cam5', 'cam19', 'cam7', 'cam3', 'cam16', 'cam18', 'cam6', 'cam14', 'cam17', 'cam13', 'cam8', 'cc', 'cam2', 'cam15', 'cam10', 'cam12', 'cam0', 'cam4', 'cam9', 'cam11'
]
...
class ClevrKiwiDataset(Dataset):
    def __init__(self,
        ...
        Args:
            root_images (str): directory to the images of the dataset
            root_meta (str): directory to the metadata of the dataset
            transforms_ ([type], optional): torchvision transform. 
            Defaults to None.
            mode (str, optional): either 'train', 'val', or 'test'. 
            Defaults to 'train'.
            canonical_mode (str, optional): [description]. 
            Defaults to 'train_only'.
            id_to_scene (dict, optional): To avoid generating a cache file
            or loading one in from disk, you can just specify the id_to_scene
            mapping here if it is already in memory. 
            Defaults to None.
        """
        ...
        if canonical_mode not in CANONICAL_MODE_SUPPORTED:
            ...
            raise Exception("Canonical mode not recognised. Must choose " + 
                            "from one of the following: {}".\
                            format(CANONICAL_MODE_SUPPORTED))
        ...
        logger.info("root_images={}, root_meta={}, mode={}".format(
            root_images, root_meta, mode
        ))
...
class ClevrDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return img, img, \
            this_q, this_cam, this_cam, this_answer, this_cam, {}
